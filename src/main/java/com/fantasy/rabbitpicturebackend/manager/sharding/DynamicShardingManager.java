package com.fantasy.rabbitpicturebackend.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // rabbit_picture.picture_1001, rabbit_picture.picture_1101
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "rabbit_picture." + tableName) // 确保前缀合法
