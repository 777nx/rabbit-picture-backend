package com.fantasy.rabbitpicturebackend.manager.upload;
...
import com.fantasy.rabbitpicturebackend.config.CosClientConfig;
...
public abstract class PictureUploadTemplate {
     ...
     * @return
     */
    private UploadPictureResult buildResult(String originalFilename, CIObject compressedCiObject, CIObject thumbnailObject, ImageInfo imageInfo) {
        // 计算宽高
...
//        uploadPictureResult.setUrl(cosClientConfig.getHost() + "/" + uploadPath);
     ...
     * @param file
     */
    public void deleteTeamFile(File file) {
        if (file == null) {
            return;
        }
        // 删除临时文件
