package com.fantasy.rabbitpicturebackend.manager.auth;
...
import com.fantasy.rabbitpicturebackend.model.enums.SpaceRoleEnum;
import com.fantasy.rabbitpicturebackend.model.enums.SpaceTypeEnum;
...
import com.fantasy.rabbitpicturebackend.service.SpaceUserService;
...
import static com.fantasy.rabbitpicturebackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    private SpaceUserAuthContext getAuthContextByRequest() {
        ...
        if (ObjUtil.isNotNull(id)) {
            ...
            // 先替换掉上下文，剩下的就是前缀
            String partURL = requestURL.replace(contextPath + "/", "");
            // 获取前缀的第一个斜杠前的字符串
